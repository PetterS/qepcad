/*===========================================================================
		    DDRPCC(m,a1,a0,b1,b0; u1,u2,v1,v2)

Double-digit restricted partial cosequence calculation.
...
void DDRPCC(m,a1,a0,b1,b0,u1_,u2_,v1_,v2_)
       Word m,a1,a0,b1,b0,*u1_,*u2_,*v1_,*v2_;
{
